<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('blogpostApp.label.home.title')" id="label-heading">Labels</span>
            <router-link :to="{name: 'LabelCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-label">
                ...
                <span  v-text="$t('blogpostApp.label.home.createLabel')">
                    Create new Label
                </span>
            </router-link>
        </h2>
        ...
        <div class="table-responsive" v-if="labels">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('blogpostApp.label.label')">Label</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="blogpostApp.label.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-label-heading" v-bind:title="$t('blogpostApp.label.delete.question')">Are you sure you want to delete this Label?</p>
            </div>
