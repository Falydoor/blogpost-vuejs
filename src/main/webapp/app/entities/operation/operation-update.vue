    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="blogpostApp.operation.home.createOrEditLabel" v-text="$t('blogpostApp.operation.home.createOrEditLabel')">Create or edit a Operation</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('blogpostApp.operation.date')" for="operation-date">Date</label>
                        <div class="d-flex">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('blogpostApp.operation.description')" for="operation-description">Description</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('blogpostApp.operation.amount')" for="operation-amount">Amount</label>
                    ...
                    <div class="form-group">
                        <label v-text="$t('blogpostApp.operation.label')" for="operation-label">Label</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('blogpostApp.operation.bankAccount')" for="operation-bankAccount">Bank Account</label>
