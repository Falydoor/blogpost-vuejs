<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('blogpostApp.bankAccount.home.title')" id="bank-account-heading">Bank Accounts</span>
            <router-link :to="{name: 'BankAccountCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-bank-account">
                ...
                <span  v-text="$t('blogpostApp.bankAccount.home.createLabel')">
        ...
        <div class="table-responsive" v-if="bankAccounts">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('blogpostApp.bankAccount.name')">Name</span></th>
                    <th><span v-text="$t('blogpostApp.bankAccount.balance')">Balance</span></th>
                    <th><span v-text="$t('blogpostApp.bankAccount.user')">User</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="blogpostApp.bankAccount.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-bankAccount-heading" v-bind:title="$t('blogpostApp.bankAccount.delete.question')">Are you sure you want to delete this Bank Account?</p>
            </div>
