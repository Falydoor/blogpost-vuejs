    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="blogpostApp.bankAccount.home.createOrEditLabel" v-text="$t('blogpostApp.bankAccount.home.createOrEditLabel')">Create or edit a BankAccount</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('blogpostApp.bankAccount.name')" for="bank-account-name">Name</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('blogpostApp.bankAccount.balance')" for="bank-account-balance">Balance</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('blogpostApp.bankAccount.user')" for="bank-account-user">User</label>
